...
\center ![](return_graph.png){height=80%} 

\note{
Due to both changing economic conditions and rising deportations, millions of Mexican migrants in the U.S. have returned to Mexico in recent years. This graph from Pew shows that net migration from Mexico to the U.S. was negative for much of the past three decades.
}
...
\note{Significant numbers of children have accompanied these return migrants. As shown here, in 2000, the Mexican census counted 258,000 U.S.-born minors. By 2010, this had more than doubled to 570,000. This number has remained fairly steady in the years since.
}

## Introduction
- Abundance of research on return migration, but few on the children who accompany returnees
- About 500,000 American-born minors live in Mexico (~2 percent of school enrollment) [@masferrer_2021_return, p. 39]
- *0.5 generation*: children of Mexican immigrants who are born in the U.S. and later migrate to Mexico [@zuniga_2018_ninas]

\note{\begin{itemize}
\item There has been an abundance of research on return migration, and yet few studies focus on children who accompany these returnees. 
\item Current estimates suggest that about 500,000 American-born minors live in Mexico, constituting about 2 percent of school enrollment. 
...
- Diverging findings in previous, mainly qualitative, studies of these children in Mexico
...
\note{\begin{itemize}
\item What does it mean to assimilate into a society where ethnic, cultural, and legal barriers are at a minimum? 
\item Assimilation theory might predict a smooth transition, and yet the small-scale studies that exist present diverging findings. 
...
\item Despite these youths' challenges in adjusting to daily life in Mexico, teachers characterize them as "star students" in their academic achievement, capitalizing on their binational and bicultural assets.
\end{itemize}}

## Introduction
**Research questions**  

- Is the typical experience of these students of academic advantage or disadvantage? 
- If disparities exist, is this due to the challenges of migration or a process of migrant selection?


\note{\begin{itemize}
\item How can we reconcile this divergence? This paper addresses two research questions. First, is the typical experience of these students of academic advantage or disadvantage? 
\item And if disparities exist, is this due to the challenges of migration or a process of migrant selection?
\end{itemize}}


<!-- - Pew estimates that from 2005 to 2010, 1.39 million Mexican immigrants returned to Mexico from the U.S., and 710,000 returned between 2013 and 2018 -->
<!-- - In large part deportations of undocumented immigrants, but 45 percent return voluntarily [@warren_2020_reverse] -->
<!-- - Precarious economic conditions in the U.S. and a stabilizing Mexican economy have increased incentives to return -->

<!-- \note{ -->
<!-- The Mexico-U.S. migration system has changed dramatically in the 21st century. After decades of high migration from Mexico to the U.S., Pew estimates that from 2005 to 2010, 1.39 million Mexican immigrants returned to Mexico from the U.S., and 710,000 returned between 2013 and 2018. -->
<!-- } -->
...
- **Rough re-entry hypothesis**: Compared to Mexican-born children in Mexico, children of return migrants attain lower PISA scores.

\note{\begin{itemize}
\item Previous theoretical work suggests why we might see diverging findings. I first consider reasons why these adolescents might be disadvantaged. Neoclassical economics suggests that return migrant families may not have found lucrative employment in the host country. 
...
\item And in the words of Cassarino's resource-mobilization framework, migrants who are not ready and willing to migrate are less likely to possess the resources to ease re-entry into Mexican society. 
\item These expectations lead to what I call the rough re-entry hypothesis: Compared to Mexican-born children in Mexico, children of return migrants attain lower PISA scores.  
\end{itemize}}
...
- **Star student hypothesis**: Compared to Mexican-born children in Mexico, children of return migrants attain higher PISA scores.
...
\item Referencing the "star student discourse" documented by Bybee et al., the star student hypothesis predicts the following: Compared to Mexican-born children in Mexico, children of return migrants attain higher PISA scores. 
\end{itemize}}
...
- **Selection hypothesis**: Compared to Spanish-speaking children of immigrants in the U.S., children of return migrants in Mexico attain lower PISA scores. However, in models adjusting for family background and resources, this disparity diminishes. 
...
- Programme for International Student Assessment (PISA) for 2012, 2015, and 2018
  ...
  + each analysis performed once for each of 5 plausible values
...
- Post-migration variables:  household wealth, home possessions, home information and communication technology (ICT) resources, and an index of economic, social and cultural status, highest parental occupational status measured (ISEI), urban locality
...
\item for reading, math and science. 
\item Each subject score has a global mean of 500 and standard deviation of 100. In the following slides, results are reported in terms of standard deviation. 
...
- U.S. comparison: `r sum(pisa_mex_us$treat == F)` Spanish-speaking children of two immigrants in the U.S.
    ...
    + PISA data for the U.S. does not allow disaggregating by parental origin, children of Mexican immigrants predominate among Spanish-speaking youth and obtain similar scores on academic assessments

\note{\begin{itemize}
\item For the 0.5 generation, how do we define "positive" or "negative" outcomes in school? Much depends on the comparison group. 
...
\item descriptively placing U.S.-born children of Mexican return migrants in the Mexican educational context. 
\item Second, I compare these children to a suitable group in the U.S.: 926 Spanish-speaking children of immigrants in the U.S. 
...
\item Unfortunately, PISA data for the U.S. does not allow disaggregating by parental origin, but previous research shows that children of Mexican immigrants predominate among Spanish-speaking youth and obtain similar scores on academic assessments as children of immigrants from other Spanish-speaking countries.
\end{itemize}}


## Data and Methods
- Difference-in-means and OLS regression estimates 
- Adjusting for pre-, then post-migration characteristics (mediators)
- Analysis of moderators
- HC1 clustered standard errors at the school level, sampling weights
- Sensitivity analysis with other estimation methods

\note{\begin{itemize}
\item I present difference-in-means and OLS regression estimates 
\item that adjust for pre- and then post-migration characteristics. 
\item I also assess the influence of moderators. 
\item All analyses use HC1 clustered standard errors at the school level and sampling weights. 
\item I also conduct sensitivity analysis with other estimation methods, though I do not present those results here.
\end{itemize}}
...
- **Star student hypothesis**: slight advantage compared to Mexican youths
- **Rough re-entry hypothesis**: stark disadvantage compared to similar U.S. adolescents
- **Selection hypothesis**: Controlling for pre- or post-migration characteristics does not change conclusions
- Little variation by moderators

\note{\begin{itemize}
\item In sum, this paper aimed to quantify the educational situation of U.S.-born children of return migrants in Mexico. Previous studies yielded mixed findings, with negative outcomes predominating. I tested three empirical expectations generated from previous work. 
\item First, the star student hypothesis held for Mexico comparisons: the 0.5 generation retains a slight advantage compared to Mexican youths. 
\item However, when I change the reference group to similar youths in the U.S., I find support for the rough re-entry hypothesis: children of return migrants in Mexico face a stark disadvantage compared to similar children in the U.S. 
\item I find little support for the selection hypothesis: controlling for pre- or post-migration characteristics does not change conclusions. 
\item There is also little variation by moderators.
\end{itemize}}


## Conclusion
- Corrective to narrative on 0.5 generation: advantaged compared to Mexican students
...
\note{\begin{itemize}
\item In conclusion, this study constitutes an important corrective to literature on the 0.5 generation in Mexico. First, by showing that the educational situation of these students is one of advantage rather than disadvantage when compared to other students in Mexico, this study contradicts much previous research on this group that depicts these students as strangers in the homeland who struggle academically. 
\item Second, this paper shows that studies that focus on only one country fail to capture the importance of institutional context. The U.S. comparisons presented here show that migration from more- to less-resourced educational contexts can entail unfortunate consequences for children's educational outcomes. 
